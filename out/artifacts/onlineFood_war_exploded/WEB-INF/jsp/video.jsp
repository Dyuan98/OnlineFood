        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <%--        餐厅信息--%>
                <ul class="nav navbar-nav">
                    <c:if test="${pageName!='video'}">
                        <li><a href="${pageContext.request.contextPath}/video">宣传视频<span class="sr-only">(current)</span></a></li>
                    </c:if>
                    <c:if test="${pageName =='video'}">
                        <li class="active"><a href="${pageContext.request.contextPath}/video">宣传视频<span class="sr-only">(current)</span></a></li>
                    </c:if>
...
<div class="container">
    <embed src="${pageContext.request.contextPath}/statics/img/food.mp4" width="1060" height="600">
</div>
