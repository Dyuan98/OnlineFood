    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <c:if test="${pageName!='orderCart'}">
                    <li><a href="${pageContext.request.contextPath}/orderCart/0">我的购物车</a></li>
                </c:if>
                <c:if test="${pageName=='orderCart'}">
                    <li class="active"><a href="${pageContext.request.contextPath}/orderCart/0">我的购物车</a></li>
                </c:if>
            ...
            <c:forEach var="order" items="${requestScope.get('orders')}">
                <tr>
                    ...
                    <td width="100px" class="active" style="text-align: center">
                        <a href="${pageContext.request.contextPath}/delOrder/${order.getOid()}">
                            <button type="button" class="btn btn-danger" style="font-size: 3px">移除</button></a>
                    </td>
                    <td width="100px" class="warning" style="text-align: center" >
                            <button type="button" class="btn btn-Info" style="font-size: 3px"
                        onclick="doPost('${pageContext.request.contextPath}/pay',{oid:'${order.getOid()}',price:'${order.getFood().getPrice()}'})">下单</button>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
