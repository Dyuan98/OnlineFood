...
<body style="background-color: #f3f5ee ">
    ...
    <div class="row">
    <div class="col-sm-6 col-md-1"></div>
        <c:forEach var="food" items="${requestScope.get('foods1')}">
        <div class="col-sm-6 col-md-2">
            <div class="thumbnail">
                <a href="${pageContext.request.contextPath}/detailsPage/${food.getFid()}/${user.getId()}">
                    <img src="${pageContext.request.contextPath}/statics/img/food${food.getImgUrl()}.jpg " width="380" height="200">
                </a>
                <div class="caption">
                    <h3>${food.getFname()}</h3>
                    <p style="color: #ff8000">店长推荐</p>
                    <p><a href="${pageContext.request.contextPath}/detailsPage/${food.getFid()}/${user.id}" class="btn btn-danger" role="button">${food.getPrice()}&nbsp;&nbsp;RMB</a>
                        <a href="${pageContext.request.contextPath}/detailsPage/${food.getFid()}/${user.id}" class="btn btn-default" role="button">查看详情</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-1"></div>
        <c:forEach var="food" items="${requestScope.get('foods2')}">
            <div class="col-sm-6 col-md-2">
                <div class="thumbnail">
                    <a href="${pageContext.request.contextPath}/detailsPage/${food.getFid()}/${user.getId()}">
                        <img src="${pageContext.request.contextPath}/statics/img/food${food.getImgUrl()}.jpg " width="380" height="200">
                    ...
                    <div class="caption">
                        <h3>${food.getFname()}</h3>
                        <p style="color: #ff8000">店长推荐</p>
                        <p><a href="${pageContext.request.contextPath}/detailsPage/${food.getFid()}/${user.getId()}" class="btn btn-danger" role="button">${food.getPrice()}&nbsp;&nbsp;RMB</a>
                            <a href="${pageContext.request.contextPath}/detailsPage/${food.getFid()}/${user.getId()}" class="btn btn-default" role="button">查看详情</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-1"></div>
        <c:forEach var="food" items="${requestScope.get('foods3')}">
            <div class="col-sm-6 col-md-2">
                <div class="thumbnail">
                    <a href="${pageContext.request.contextPath}/detailsPage/${food.getFid()}/${user.getId()}">
                        <img src="${pageContext.request.contextPath}/statics/img/food${food.getImgUrl()}.jpg " width="380" height="200">
    ...
    <nav aria-label="Page navigation">
        ...
        <ul class="pagination">
            ...
            <li class="active">
                ...
                <a href="${pageContext.request.contextPath}/main/${currPage-1}" aria-label="Previous" >
            ...
            <c:forEach begin="1" end="${totalPages}" var="num">
                ...
                <c:if test="${currPage == num}">
                    <li class="active"><a href="${pageContext.request.contextPath}/main/${num}">${num}</a></li>
                </c:if>
                <c:if test="${currPage != num}">
                    <li><a href="${pageContext.request.contextPath}/main/${num}">${num}</a></li>
                </c:if>
            </c:forEach>
            ...
            <li class="active">
                ...
                <a href="${pageContext.request.contextPath}/main/${currPage+1}" aria-label="Next" >
